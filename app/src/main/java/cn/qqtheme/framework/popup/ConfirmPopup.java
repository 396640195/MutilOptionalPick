...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topBackgroundColor = 0xFFCEA56B;
    ...
    protected int cancelTextColor = 0xFFFFFFFF;
    protected int submitTextColor = 0xFFFFFFFF;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0xFFFFFFFF;
